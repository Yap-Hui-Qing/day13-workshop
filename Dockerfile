...
# ./target/day13-workshop-0.0.1-SNAPSHOT.jar
...
# run the application
ENTRYPOINT SERVER_PORT=${PORT} java -jar target/day13-workshop-0.0.1-SNAPSHOT.jar
...
COPY --from=builder /app/target/day13-workshop-0.0.1-SNAPSHOT.jar vttpb-ssf-day13-workshop.jar
...
ENTRYPOINT SERVER_PORT=${PORT} java -jar vttpb-ssf-day13-workshop.jar